...
document.getElementById("InputGrassGrow").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputFireLifespan").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputFireBurn").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputWaterFlow").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputWaterEvaporate").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputLavaFlow").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputLavaBurn").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputLavaFade").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputIceFlow").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputIceMelt").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
document.getElementById("InputIceEvaporate").addEventListener("input", function (Event) {
    var InputField = Event.target;
    InputField.value = InputField.value.replace(/[^0-9]/g, "");
    var Value = Number(InputField.value);
    try {
...
//#endregion
//#region Reset
document.getElementById("ButtonResetSettings").addEventListener("click", function (Event) {
